...
% **************************************************
\newcommand{\thesisTitle}{Deep Learning Next-Activity Prediction With Cluster-Based Input Data}
...
\newcommand{\thesisSecondReviewer}{Prof. Dr. Stefan Lessmann}
\newcommand{\thesisSecondReviewerUniversity}{\protect{Humboldt Universität Zu Berlin}}
\newcommand{\thesisSecondReviewerDepartment}{Information Systems Group}

\newcommand{\thesisFirstSupervisor}{Dr. Luise Pufahl}
\newcommand{\thesisSecondSupervisor}{Dr. Feng Cheng}
